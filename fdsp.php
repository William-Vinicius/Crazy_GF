...
<head>
   <meta charset="UTF-8">
   <title>Site Maneiro</title>
   <link rel="stylesheet" href="SRC/CSS/style2.css">
</head>

<body>
   <h1 class="t1">Justiça Federal manda tirar do ar Telegram do Brasil após pedido da PF</h1>
   <div class="espaço1"></div>
   <h2 class="t2">O vídeo fornece uma maneira poderosa de ajudá-lo a provar seu argumento. Ao clicar em Vídeo Online.
   </h2>
   ...
   <p>Você também pode digitar uma palavra-chave para pesquisar online o vídeo mais adequado ao seu documento. Para dar
      ao documento uma aparência profissional,
      o Word fornece designs de cabeçalho, rodapé,
      folha de rosto e caixa de texto que se complementam entre si. :S
   </p>
